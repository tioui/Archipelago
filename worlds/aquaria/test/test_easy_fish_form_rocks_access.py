...
class EasyFishFormRocksAccessTest(AquariaTestBase):
    ...
    options = {
        ...
        "go_around_rocks_with_fish_form": GoAroundRocksWithFishForm.option_easy_only
    }

    def test_easy_fish_form_rocks_location(self) -> None:
